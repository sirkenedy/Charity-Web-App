 ...
 * ===================================================== */
$email_to = "owoputikehinde@gmail.com"; 
...
if(isset($_POST['email']))
{
    ...
    {
        echo json_encode(array('success'=>1, 'message'=>'Form submitted successfully. An email will be sent you in less than 72hours.<br> Thanks for raechin out to us')); 
    }

    else 
    {
        echo json_encode(array('success'=>0, 'message'=>$email_message)); 
        die();        
    }
}
else
